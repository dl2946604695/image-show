...
import { getPhotos, setPhotos, ensureSeed } from '../../../_lib/store.js';

export async function onRequest(context) {
  if (context.request.method === 'OPTIONS') return corsPreflight();
  if (context.request.method !== 'PUT') return json(405, { error: 'Method not allowed' });
  ...
  return json(200, { success: true, data: { likes: photo.likes } });
}
